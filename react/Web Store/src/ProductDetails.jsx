    ...
    return (
        <>
            ...
            <div className="details">
                <div>
                    <img src={details.thumbnail} alt={details.name} width="612" height="408" className="details-image" />
                ...
                <div>
                    ...
                    <p className="text-dimmed" dangerouslySetInnerHTML={{ __html: details.description }}
                    ></p>
                    <div className="details-a2c">
                        <button className="btn btn-block" onClick={() => handleAddProduct(details)}>
                            Add to cart
                        </button>
                    </div>
                </div>
