<template>
  <q-page padding>
    ...
    <div v-else>
      <NCESContainer
        v-if="!loading"
        override-title="NCES Final Contact"
...
import { transformFinalNCES } from '../lib/data-transformers'
...
export default {
  ...
  setup() {
    ...
    const { loading, result: ncesDetails } = useQuery(
      gql`
        query GetNCESDetailsFinal($incidentId: ID!, $kind: NCESContactKind!) {
